<template>
  <div class="Company">
    ...
    <b-form-group id="input-group-2" label="Организационно-правовая форма:" label-for="input-2">
      <b-form-input id="input-2" v-model="content.opforma"  placeholder="Организационно-правовая форма"></b-form-input>
    </b-form-group>
    <b-form-group id="input-group-3" label="Основной вид деятельности:" label-for="input-3">
      <b-form-input id="input-3" v-model="content.activity"  placeholder="Основной вид деятельности"></b-form-input>
    </b-form-group>
    ...
    <b-form-group id="input-group-10" label="Руководитель:" label-for="input-10">
      <b-form-input id="input-10" v-model="content.sepervisor.dir"  placeholder="Руководитель"></b-form-input>
    </b-form-group>
...
export default {
  ...
  methods: {
    save() {
      ...
      console.log(name, opforma, activity, address, phone, fax, email, supervisor, id )
    },
